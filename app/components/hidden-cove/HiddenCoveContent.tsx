...
const HiddenCoveContent = () => {
  ...
  return (
    <div className="bg-gray-900 min-h-[calc(100vh-68px)]">
      ...
      {/* Features Section */}
      <div className="max-w-7xl mx-auto px-3 py-6 sm:px-8">
          ...
          {features.map((feature, index) => {
            ...
            return (
              <motion.div
                ...
                className="border border-white/10 bg-white/2 rounded-2xl p-8 shadow-lg backdrop-blur-sm hover:bg-white/5 transition-all duration-300"
              >
                <div className="space-y-6 flex flex-col h-full justify-between">
                    ...
                    <div className="space-y-3">
                      {feature.capabilities.map((capability, capIndex) => (
                        <div key={capIndex} className="flex items-start space-x-3">
                          <div className={`w-2 h-2 rounded-full bg-${feature.accentColor} mt-2 shrink-0`} />
                          <div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                      <div className="w-full px-4 py-2 rounded-lg border border-white/20 hover:border-white/30 text-sm font-medium text-white hover:bg-white/5 transition-all duration-200 flex items-center justify-center">
...
export default HiddenCoveContent
