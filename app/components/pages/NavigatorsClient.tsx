...
import NavigatorCard from '@/app/components/admin/NavigatorCard'
            ...
            .map((status, index) => (
              ...
              >
                <div className="flex items-center justify-between gap-2">
                  ...
                  <div className={`p-1.5 xs:p-2 sm:p-3 rounded-lg shrink-0 ${getNavigatorStatusColor(status.value)}`}>
        ...
        <div className="sticky top-0 z-20 flex flex-col md:flex-row gap-4">
          ...
          <div className="flex gap-2">
            <select
              ...
              className="px-4 py-3 bg-gray-800/50 border border-gray-700 rounded-lg text-white focus:ring-2 focus:ring-violet-400 focus:border-violet-400 transition-all focus:outline-none  w-full md:w-fit"
            >
              {navigatorStatusOptions(data).map((option) => (
...
export default NavigatorsClient
