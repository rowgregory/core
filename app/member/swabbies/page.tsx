...
import MemberSwabbieCard from '@/app/components/swabbie/MemberSwabbieCard'
import InfoBanner from '@/app/components/common/InfoBanner'

const MemberSwabbiesPage = () => {
        ...
        <div className="grid grid-cols-1 2xl:grid-cols-2 3xl:grid-cols-3 gap-7">
          <AnimatePresence>
            {filteredSwabbies?.map((swabbie, index) => (
              <MemberSwabbieCard key={swabbie.id} swabbie={swabbie} index={index} />
            ))}
          </AnimatePresence>
        </div>
...
export default MemberSwabbiesPage
