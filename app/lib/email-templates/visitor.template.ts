export const visitorInviteTemplate = ({
  ...
  const presenterBlock = presenterName
    ? `
          <tr>
          ...
          <tr>
            <td style="padding: 24px 32px 20px;">
              <p style="margin: 0; color: #64748b; font-size: 14px; line-height: 1.7;">
                Hi <strong style="color: #0c1e2e;">${visitorFirstName}</strong>, <strong style="color: #0c1e2e;">${invitedByName}</strong> has invited you to visit our meeting on <strong style="color: #0c1e2e;">${visitDate}</strong>. We'd love to have you — here's everything you need to know.
              </p>
            </td>
          </tr>
