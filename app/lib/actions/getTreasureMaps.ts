...
export async function getTreasureMaps() {
  try {
    ...
    await createLog('error', 'Failed to fetch treasure maps', {
      location: ['server action - getTreasureMaps'],
      message: error instanceof Error ? error.message : 'Unknown error',
      name: 'GetTreasureMapsError',
